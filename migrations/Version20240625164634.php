 ...
 */
final class Version20240625164634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(sql: 'ALTER TABLE work_tasks ADD CONSTRAINT FK_78A31EB8582AE764 FOREIGN KEY (work_order_id) REFERENCES work_orders (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql(sql: 'ALTER TABLE work_tasks DROP FOREIGN KEY FK_78A31EB8582AE764');
        $this->addSql(sql: 'DROP TABLE constats');
        $this->addSql(sql: 'DROP TABLE `users`');
        $this->addSql(sql: 'DROP TABLE work_orders');
        $this->addSql(sql: 'DROP TABLE work_tasks');
        $this->addSql(sql: 'DROP TABLE messenger_messages');
    }
}
